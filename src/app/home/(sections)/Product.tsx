...
const Product = () => {
  ...
  return (
    ...
    //     <h2
    //       className='text-[32px] leading-[32px] font-bold mb-[54px]'
    //       data-aos='zoom-in-up'
    //     >
    //       We Serve
    //     </h2>
    ...
    //     <div
    //       className='grid grid-cols-12 gap-6 items-center w-full mb-[64px]'
    //       data-aos='zoom-in-up'
    //     >
    //       {/* Image Left */}
    //       <div className='col-span-12 md:col-span-6 mb-[32px] relative h-[350px]'>
    //         <Image
    ...
    //       </div>
    //       {/* Text Right */}
    //       <div className='col-span-12 md:col-span-6 mb-[32px]'>
    //         <h3 className='text-[32px] leading-[32px] font-bold text-[#326E3B] mb-[32px]'>
    //           Roasted Green Tea
    //         </h3>
    //         <p className='text-[16px] leading-[28px] text-gray-700'>
    //           Expertly crafted from freshly picked leaves, our roasted green tea
    //           offers a smooth, rich flavor with a distinctive aroma. Carefully
    //           roasted and dried to preserve its natural qualities, it is rich in
    //           antioxidants and known for promoting brain function, supporting
    //           metabolism, and enhancing overall well-being.
    //         </p>
    //       </div>
    //     </div>
    ...
    //     >
    //       {/* Text Left */}
    //       <div className='col-span-12 md:col-span-6 mb-[32px] order-2 md:order-1'>
    //         <h3 className='text-[32px] leading-[32px] font-bold text-[#326E3B] mb-[32px]'>
    //           Orthodox Black Tea
    //         </h3>
    //         <p className='text-[16px] leading-[28px] text-gray-700'>
    ...
    //           support heart health, digestion, and overall wellness — a perfect
    //           energizing brew for tea lovers seeking both strength and benefits.
    //         </p>
    //       </div>
    //       {/* Image Right */}
    //       <div className='col-span-12 md:col-span-6 mb-[32px] relative h-[350px] order-1 md:order-2'>
    //         <Image
    //           src='/image/rampokh-about-us.jpg'
    ...
    //     <div
    //       className='grid grid-cols-12 gap-6 items-center w-full'
    //       data-aos='zoom-in-up'
    //     >
    //       {/* Image Left */}
    //       <div className='col-span-12 md:col-span-6 mb-[32px] relative h-[350px]'>
    ...
    //           Green Tea is delicately rolled for a smooth, refreshing taste with
    //           natural sweetness. Rich in antioxidants and nutrients, it supports
    //           overall wellness while offering exceptional flavor — a perfect
