...
//             data-aos='fade-left'
//           >
//             <div className='bg-[#326E3B] text-white p-5 rounded-xl shadow'>
...
//               <Phone className='w-6 h-6 text-[#326E3B]' />
//               <p>
...
//             <div className='bg-gray-100 p-5 rounded-xl shadow flex items-start space-x-3'>
//               <Mail className='w-6 h-6 text-[#326E3B]' />
//               <div>
    ...
    <div className='container mx-auto '>
      <div className='py-16 md:py-24'>
        <div className='grid grid-cols-1 md:grid-cols-12 gap-6 items-center'>
          {/* Contact Form */}
          <div
            className='col-span-1 md:col-span-6 bg-white shadow-md rounded-2xl '
            data-aos='fade-up'
          >
          ...
          {/* Contact Info */}
          <div
            className='col-span-1 md:col-start-8 md:col-span-5 flex flex-col space-y-4 mt-6 md:mt-0'
            data-aos='fade-left'
          >
            <div className='bg-[#326E3B] text-white p-5 rounded-xl shadow flex items-start space-x-3'>
              <MapPin className='w-6 h-6 mt-1' />
              <a
                href='https://www.google.com/maps/place/Rampokh,+Suryadaya+Municipality-9,+Fikal,+Ilam'
                target='_blank'
            ...
            <div className='bg-gray-100 p-5 rounded-xl shadow flex items-start space-x-3'>
              <Building className='w-6 h-6 text-[#326E3B]' />
              <p>Rampokha Green Tea and Agro Processing Industries Pvt. Ltd</p>
            </div>
          </div>
        </div>
